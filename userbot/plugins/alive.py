...
CUSTOM_ALIVE_TEXT = Config.CUSTOM_ALIVE_TEXT or "Yo it's me dogbot a version of catuserbot `Woof`🐶"
...
async def amireallyalive(alive):
    ...
    if CAT_IMG:
        ...
        cat_caption += f"**{EMOJI} dogbot Version :** `{catversion}`\n"
        cat_caption += f"**{EMOJI} Python Version :** `{python_version()}\n`"
        cat_caption += f"**{EMOJI} Uptime :** `{uptime}\n`"
        cat_caption += f"**{EMOJI} Master:** {mention}\n"
        cat_caption += f"**{EMOJI} Device:** Dell Inspiron (os system - windows)\n"
        ...
        await edit_or_reply(
            ...
            f"**{EMOJI} dogbot Version :** `{catversion}`\n"
